      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="mt-16 grid items-stretch gap-6 lg:grid-cols-3">
          {plans.map((plan, index) => {
            ...
            const buttonClassName = `inline-flex w-full items-center justify-center rounded-xl px-5 py-3.5 font-black transition ${
              plan.featured
        ...
        >
          ...
          <div className="mt-9 grid gap-4 md:grid-cols-3">
            {creditPacks.map((pack) => {
              const creditButtonClassName = `mt-5 inline-flex w-full items-center justify-center rounded-xl px-4 py-3 text-sm font-black transition ${
                pack.featured
