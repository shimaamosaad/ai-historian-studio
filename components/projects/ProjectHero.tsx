    ...
    <section className="relative overflow-hidden rounded-[34px] border border-white/10 bg-[#081525] shadow-2xl shadow-black/40">
      ...
      <div className="relative grid min-h-[390px] items-center gap-8 p-6 sm:p-8 lg:grid-cols-[1.25fr_0.75fr] lg:p-12">
        <div>
          ...
          <h1 className="mt-6 max-w-5xl text-4xl font-black leading-[1.2] sm:text-5xl lg:text-7xl">
            {project.title}
          </h1>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a
              ...
              className="inline-flex items-center justify-center rounded-2xl bg-gradient-to-l from-amber-400 to-orange-500 px-6 py-4 font-bold text-slate-950 transition hover:-translate-y-0.5 hover:shadow-lg hover:shadow-amber-500/20"
            >
              رفع مستند جديد
            </a>
            ...
            <a
              href="#documents"
              className="inline-flex items-center justify-center rounded-2xl border border-white/15 bg-white/[0.04] px-6 py-3.5 font-bold text-white transition hover:border-amber-400/30 hover:bg-amber-400/[0.06]"
            >
              استعراض المستندات
            </a>
          </div>
